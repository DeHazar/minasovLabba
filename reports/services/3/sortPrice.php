...
$query= sprintf("SELECT * FROM telescops WHERE weight > 3 ORDER BY price DESC");
...
<h3 style="text-align: center; visibility: visible; ">Сортировка по цене телескопа по выборке с весом больше 3 кг</h3>
