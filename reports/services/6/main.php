    ...
    <div class="col s5 center">
            <div class="card grey lighten-3 wrapper center-block">
                <div class="card-content center">
                    <div class="row">
                        <a class="waves-effect waves-light btn" style="width: 200px;" href="signIn.php"> Войти</a>

                    </div>
                    <div class="row">
                        <a class="waves-effect waves-light btn" style="width: 200px;" href="signUp.php"> Регистрация</a>
